    ...
    d.init = function () {
      ...
      if (d.vars.animation.toLowerCase() == 'slide') {
        ...
        if (d.vars.animationLoop) {
          ...
          d.cloneOffset = 1
          d.container
            .append(d.slides.filter(':first').clone().addClass('clone'))
        ...
        if (d.vertical) {
          ...
          setTimeout(function () {
            ...
            d.args[d.prop] = d.transitions
              ? 'translate3d(0,' + m * d.height() + 'px,0)'
              : m * d.height() + 'px'
            d.container.css(d.args)
          }, 100)
        } else {
          d.args[d.prop] = d.transitions
            ? 'translate3d(' + m * d.width() + 'px,0,0)'
            : m * d.width() + 'px'
        ...
        d.slides
          ...
          .eq(d.currentSlide)
          .fadeIn(d.vars.animationDuration)
      }
      ...
      if (d.vars.pausePlay) {
        ...
        d.pausePlay
          .addClass(n)
          .text(n == 'pause' ? d.vars.pauseText : d.vars.playText)
      ...
      if ('ontouchstart' in document.documentElement && d.vars.touch) {
        ...
        function k(i) {
          ...
          p = d.vertical
            ? Math.abs(o) < Math.abs(i.touches[0].pageX - u)
          ...
          if (!p) {
            ...
            if (d.vars.animation == 'slide' && d.transitions) {
              if (!d.vars.animationLoop) {
                o =
                  o /
                  ((d.currentSlide == 0 && o < 0) ||
                  (d.currentSlide == d.count - 1 && o > 0)
                    ? Math.abs(o) / r + 2
                    : 1)
              }
              d.args[d.prop] = d.vertical
                ? 'translate3d(0,' + (-l - o) + 'px,0)'
        ...
        a(window).resize(function () {
          if (!d.animating && d.is(':visible')) {
            if (d.vertical) {
              ...
              d.args[d.prop] =
                -1 * (d.currentSlide + d.cloneOffset) * d.width() + 'px'
              if (d.transitions) {
                d.setTransition(0)
                d.args[d.prop] = d.vertical
                  ? 'translate3d(0,' + d.args[d.prop] + ',0)'
