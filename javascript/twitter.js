  ...
  $.fn.tweet = function (o) {
    ...
    $.fn.extend({
      ...
      linkUser: function () {
        ...
        this.each(function () {
          returning.push(
            this.replace(
              regexp,
              '@<a href="https://' + s.twitter_url + '/$1">$1</a>'
            )
          )
        })
      ...
      linkHash: function () {
        ...
        var usercond =
          s.username && s.username.length == 1
      ...
      capEpic: function () {
        ...
        this.each(function () {
          returning.push(
            this.replace(/\b(epic)\b/gi, '<span class="epic">$1</span>')
          )
        })
        ...
        .bind('load', function () {
          $.getJSON(build_url(), function (data) {
            ...
            var tweets = $.map(data.results || data, function (item) {
              ...
              var retweeted_screen_name = retweet
              ...
              var join = s.join_text
                ? '<span class="tweet_join"> ' + join_text + ' </span>'
                : ' '
              ...
              var text =
                ...
                $([tweet_text]).makeHeart().capAwesome().capEpic()[0] +
                '</span>'
