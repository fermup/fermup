...
;(window.Modernizr = (function (a, b, c) {
  ...
  var d = '2.0.6',
    ...
    q = { svg: 'https://www.w3.org/2000/svg' },
    r = {},
    s = {},
    t = {},
    u = [],
  ...
  for (var J in r)
    A(r, J) &&
      ((y = J.toLowerCase()), (e[y] = r[J]()), u.push((e[y] ? '' : 'no-') + y))
  e.input || I(),
      ...
      (function (a, b) {
        ...
        ;(d.getCSS = function (a, b) {
          ...
          (d._beforePrint = function () {
            ;(p.styleSheet.cssText = d.parseCSS(
              d.getCSS(b.styleSheets, 'all')
            )),
              d.writeHTML()
          }),
  ...
  (function (a, b, c) {
    ...
    ;(H = function (a) {
      ...
      function e(a, b, e, g, h) {
        ...
        if (!i.bypass) {
          b &&
            (b = D(b) ? b : b[a] || b[g] || b[a.split('/').pop().split('?')[0]])
